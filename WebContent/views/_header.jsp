                    		...
                    		<c:when test="${!empty sessionScope.user}">	
			                    <li class="dropdown">
						          ...
						          <ul class="dropdown-menu" role="menu">
						            ...
						            <li><a href="<c:url value="/Inscription"/>"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> <fmt:message key="general.myarticles" /></a></li>
						            <li><a href="<c:url value="/Connexion"/>"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span><fmt:message key="general.addarticle" /></a></li>
